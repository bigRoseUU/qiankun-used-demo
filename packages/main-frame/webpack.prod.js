    ...
    rules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: '/Users/linjiamin/personald-demo/vue-qiankun-demo/node_modules/@vue/cli-service/node_modules/vue-loader/dist/index.js',
            options: {
              cacheDirectory: '/Users/linjiamin/personald-demo/vue-qiankun-demo/packages/main-frame/node_modules/.cache/vue-loader',
              cacheIdentifier: '988ddc88',
              babelParserPlugins: [
                'jsx',
                'classProperties',
                'decorators-legacy'
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/Users/linjiamin/personald-demo/vue-qiankun-demo/node_modules/mini-css-extract-plugin/dist/loader.js',
                options: {
                  publicPath: '../'
                }
              },
              ...
              {
                loader: '/Users/linjiamin/personald-demo/vue-qiankun-demo/node_modules/@vue/cli-service/node_modules/css-loader/dist/cjs.js',
                options: {
                  sourceMap: false,
                  importLoaders: 2,
                  modules: {
              ...
              {
                loader: '/Users/linjiamin/personald-demo/vue-qiankun-demo/node_modules/postcss-loader/dist/cjs.js',
                options: {
                  sourceMap: false,
                  postcssOptions: {
                    plugins: {
                      autoprefixer: {},
                      tailwindcss: {
                        config: '/Users/linjiamin/personald-demo/vue-qiankun-demo/tailwind.config.js'
                      }
                    }
                  }
                }
        ...
        oneOf: [
          /* config.module.rule('less').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/Users/linjiamin/personald-demo/vue-qiankun-demo/node_modules/less-loader/dist/cjs.js',
                options: {
                  sourceMap: false
                }
              }
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          ...
          {
            loader: '/Users/linjiamin/personald-demo/vue-qiankun-demo/node_modules/thread-loader/dist/cjs.js'
          },
      ...
      /* config.module.rule('ts') */
      {
        ...
        use: [
          ...
          {
            loader: '/Users/linjiamin/personald-demo/vue-qiankun-demo/node_modules/ts-loader/index.js',
            options: {
              transpileOnly: true,
              appendTsSuffixTo: [
                '\\.vue$'
    ...
    new ESLintWebpackPlugin(
      {
        ...
        cache: true,
        cacheLocation: '/Users/linjiamin/personald-demo/vue-qiankun-demo/packages/main-frame/node_modules/.cache/eslint/498d2f66.json',
        context: '/Users/linjiamin/personald-demo/vue-qiankun-demo/packages/main-frame',
        failOnWarning: false,
        failOnError: true,
    ...
    new ForkTsCheckerWebpackPlugin(
      {
        typescript: {
          extensions: {
            vue: {
              enabled: true,
              compiler: '/Users/linjiamin/personald-demo/vue-qiankun-demo/node_modules/vue/compiler-sfc/index.js'
            }
          },
          diagnosticOptions: {
            semantic: true,
